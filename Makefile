...
OTHER_TARGETS = $(MATLAB_TARGET) $(TEST_TARGET) $(MATLAB_TEST_TARGET) $(MOCK_TARGET)
ALL_TARGETS = $(PRIMARY_TARGET) $(VERSION_TARGET) $(FRIENDLY_TARGET) $(OTHER_TARGETS)
...
$(PRIMARY_TARGET): % : $(TARGETDIR)/% $(TARGETDIR)
	$(LN) $(PRIMARY_TARGET) $(TARGETDIR)/$(VERSION_TARGET)
	$(LN) $(VERSION_TARGET) $(TARGETDIR)/$(FRIENDLY_TARGET)
...
install: opt
	...
	$(LN) $(PRIMARY_TARGET) $(LIB_DIR)/$(VERSION_TARGET)
	$(LN) $(VERSION_TARGET) $(LIB_DIR)/$(FRIENDLY_TARGET)
