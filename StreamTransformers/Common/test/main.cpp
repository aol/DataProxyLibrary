//
// FILE NAME:		$HeadURL: svn+ssh://pnguyen7@svn.cm.aol.com/advertising/adlearn/gen1/trunk/lib/cpp/DataProxy/StreamTransformers/GroupingAggregator/test/main.cpp $
//
// REVISION:		$Revision: 263970 $
// 
// COPYRIGHT:		(c) 2008 Advertising.com All Rights Reserved.
// 
// LAST UPDATED:	$Date: 2012-11-19 14:33:01 -0500 (Mon, 19 Nov 2012) $
...
int main(int argc, char** argv)
{
    try
    {
		...
		std::ofstream outFile("common_tests_result");
