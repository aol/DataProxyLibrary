//
// FILE NAME:		$HeadURL: svn+ssh://svn.cm.aol.com/advertising/adlearn/gen1/trunk/lib/cpp/DataProxy/StreamTransformers/Blackout/test/main.cpp $
//
...
int main(int argc, char** argv)
{
    try
    {
		...
		std::ofstream outFile("shell_stream_transformer_tests_result");
