// FILE NAME:       $HeadURL: svn+ssh://svn.cm.aol.com/advertising/adlearn/gen1/trunk/lib/cpp/DataProxy/test/AbstractNodeTest.hpp $
//
...
private:
	...
	CPPUNIT_TEST( testStoreTranslateMD5Parameter );
...
public:
	...
	void testStoreTranslateMD5Parameter();
