// FILE NAME:       $HeadURL: svn+ssh://svn.cm.aol.com/advertising/adlearn/gen1/trunk/lib/cpp/DataProxy/test/PartitionNodeTest.cpp $
//
...
void PartitionNodeTest::testOperationAttributeParsing()
{
	MockDataProxyClient client;
	std::stringstream xmlContents;
	xmlContents << "<PartitionNode>" << std::endl
				...
				<< "    <ForwardTo name=\"name1\" />" << std::endl
				<< "  </Read>" << std::endl
				<< "  <Write operation=\"ignore\" partitionBy=\"key\" sortTimeout=\"10\" >" << std::endl
				<< "    <ForwardTo name=\"name1\" />" << std::endl
				<< "  </Write>" << std::endl
