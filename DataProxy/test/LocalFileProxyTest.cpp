// FILE NAME:       $HeadURL: svn+ssh://svn.cm.aol.com/advertising/adlearn/gen1/trunk/lib/cpp/DataProxy/test/LocalFileProxyTest.cpp $
//
...
void LocalFileProxyTest::testStoreCommitOverwrite()
{
	...
	CPPUNIT_ASSERT_EQUAL( filePending, dirFiles[1] );
